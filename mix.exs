...
defmodule BB.Servo.Feetech.MixProject do
  use Mix.Project
  ...
  defp package do
    [
      ...
      links: %{
        "Source" => "https://github.com/beam-bots/bb_servo_feetech",
  ...
  defp docs do
    [
      ...
      source_ref: "main",
      source_url: "https://github.com/beam-bots/bb_servo_feetech"
    ]
  end
